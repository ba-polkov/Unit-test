...
class TestBurgerClass:
    ...
    def test_set_buns_upper_and_lower_buns_successfully(self, burger):
        mock_bun_1 = Mock()
    ...
    def test_add_ingredient_any_ingredient_successfully(self, burger, ingredient_type, ingredient_name, ingredient_price):
    ...
    def test_add_ingredient_2_sauces_and_2_fillings(self, burger, mock_sauce_2, mock_sauce_3, mock_filling_2, mock_filling_3):
    ...
    def test_add_ingredients_3_same_sauces_and_3_same_fillings(self, burger, mock_sauce_1, mock_filling_1):
        burger.add_ingredient(mock_sauce_1)
        burger.add_ingredient(mock_sauce_1)
        burger.add_ingredient(mock_sauce_1)
        burger.add_ingredient(mock_filling_1)
    ...
    def test_remove_ingredient_only_one_ingredient_in_list(self, burger, mock_sauce_1):
        burger.add_ingredient(mock_sauce_1)
        burger.remove_ingredient(0)
        assert len(burger.ingredients) == 0

    # Удаляем два ингредиента из списка из двух ингредиентов
    def test_remove_ingredient_remove_2_ingredients_from_list(self, burger, mock_sauce_3, mock_filling_3):
        burger.add_ingredient(mock_sauce_3)
        burger.add_ingredient(mock_filling_3)
        burger.remove_ingredient(0)
        burger.remove_ingredient(0)
    ...
    def test_remove_ingredient_remove_second_ingredient_from_list(self, burger, mock_sauce_2, mock_filling_2):
        burger.add_ingredient(mock_sauce_2)
        burger.add_ingredient(mock_filling_2)
    ...
    def test_move_ingredient_change_2_ingredients(self, burger, mock_sauce_2, mock_filling_2):
        burger.add_ingredient(mock_sauce_2)
        burger.add_ingredient(mock_filling_2)
    ...
    def test_move_ingredient_change_3_ingredients(self, burger, mock_sauce_2, mock_filling_2, mock_sauce_3):
        burger.add_ingredient(mock_sauce_2)
        burger.add_ingredient(mock_filling_2)
        burger.add_ingredient(mock_sauce_3)
    ...
    def test_get_price_only_red_buns(self, burger, mock_red_bun):
    ...
    def test_get_price_2_red_buns_and_chili_sauce_and_sausage(self, burger, mock_red_bun, mock_sauce_3, mock_filling_3):
        burger.set_buns(mock_red_bun)
        burger.add_ingredient(mock_sauce_3)
        burger.add_ingredient(mock_filling_3)
    ...
    def test_get_price_2_red_buns_and_hot_sauce_and_sour_cream_and_dinosaur_and_sausage(self, burger, mock_red_bun, mock_sauce_1, mock_sauce_2, mock_filling_2, mock_filling_3):
        burger.set_buns(mock_red_bun)
        burger.add_ingredient(mock_sauce_1)
        burger.add_ingredient(mock_sauce_2)
        burger.add_ingredient(mock_filling_2)
    ...
    def test_get_receipt_2_red_buns(self, burger, mock_red_bun):
        burger.set_buns(mock_red_bun)
    ...
    def test_get_receipt_2_red_buns_and_hot_sauce_and_cutlet(self, burger, mock_red_bun, mock_sauce_1, mock_filling_1):
        burger.set_buns(mock_red_bun)
        burger.add_ingredient(mock_sauce_1)
        burger.add_ingredient(mock_filling_1)
        receipt = burger.get_receipt()
