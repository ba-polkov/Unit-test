...
class TestDatabase:
    ...
    def test_available_buns_quantity(self):
        database = Database()
        buns_list = database.available_buns()
        assert len(buns_list) == 3

    def test_available_buns_correct_info(self):
        database = Database()
        buns = database.available_buns()
        expected_list = BunData.list_buns
        actual_list = []
    ...
    def test_available_ingredients_quantity(self):
        database = Database()
