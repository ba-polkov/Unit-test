...
class TestDatabase:
    ...
    def test_available_buns_set(self, database, name, expected_count):
    ...
    def test_available_ingredients_set(self, database, type, name, expected_count):
    ...
    def test_available_ingredients_prices(self, database):
        ingredients = database.available_ingredients()
        count = all(filter(lambda ingredient: ingredient.price > 0, ingredients))
