...
class TestBurger:
    ...
    def test_receipt_includes_bun_name_for_empty_burger(self, burger, mock_bun):
        burger.set_buns(mock_bun)
    ...
    def test_receipt_includes_bun_name(self, burger, mock_bun, mock_ingredient_filling, mock_ingredient_sauce):
        burger.set_buns(mock_bun)
        burger.add_ingredient(mock_ingredient_sauce)
        burger.add_ingredient(mock_ingredient_filling)
    ...
    def test_receipt_includes_sauce_name(self, burger, mock_bun, mock_ingredient_filling, mock_ingredient_sauce):
        burger.set_buns(mock_bun)
        burger.add_ingredient(mock_ingredient_sauce)
        burger.add_ingredient(mock_ingredient_filling)
    ...
    def test_receipt_includes_filling_name(self, burger, mock_bun, mock_ingredient_filling, mock_ingredient_sauce):
        burger.set_buns(mock_bun)
        burger.add_ingredient(mock_ingredient_sauce)
        burger.add_ingredient(mock_ingredient_filling)
    ...
    def test_receipt_includes_correct_price(self, burger, mock_bun, mock_ingredient_filling, mock_ingredient_sauce):
        burger.set_buns(mock_bun)
        burger.add_ingredient(mock_ingredient_sauce)
        burger.add_ingredient(mock_ingredient_filling)
